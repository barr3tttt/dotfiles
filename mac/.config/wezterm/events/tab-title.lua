...
-- stylua: ignore
local colors = {
   text_default          = { bg = '#44475a', fg = '#f8f8f2' },
   text_hover            = { bg = '#6272a4', fg = '#f8f8f2' },
   text_active           = { bg = '#bd93f9', fg = '#191a21' },

   unseen_output_default = { bg = '#44475a', fg = '#ff79c6' },
   unseen_output_hover   = { bg = '#6272a4', fg = '#ff79c6' },
   unseen_output_active  = { bg = '#bd93f9', fg = '#ff79c6' },

   scircle_default       = { bg = 'rgba(0, 0, 0, 0.4)', fg = '#44475a' },
   scircle_hover         = { bg = 'rgba(0, 0, 0, 0.4)', fg = '#6272a4' },
   scircle_active        = { bg = 'rgba(0, 0, 0, 0.4)', fg = '#bd93f9' },

   progress_percentage_default    = { bg = '#44475a', fg = '#50fa7b' },
   progress_percentage_hover      = { bg = '#6272a4', fg = '#50fa7b' },
   progress_percentage_active     = { bg = '#bd93f9', fg = '#50fa7b' },

   progress_error_default         = { bg = '#44475a', fg = '#ff5555' },
   progress_error_hover           = { bg = '#6272a4', fg = '#ff5555' },
   progress_error_active          = { bg = '#bd93f9', fg = '#ff5555' },

   progress_indeterminate_default = { bg = '#44475a', fg = '#f8f8f2' },
   progress_indeterminate_hover   = { bg = '#6272a4', fg = '#f8f8f2' },
   progress_indeterminate_active  = { bg = '#bd93f9', fg = '#f8f8f2' },
}
